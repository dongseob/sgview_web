  ...
  return (
    <>
      ...
      <motion.div
        ...
        style={{ background: 'linear-gradient(0deg, #FFFFFF 0%, #FCC9C7 100%)' }}
      >
        <div className="pt-[152px] flex flex-col items-center">
          ...
          >
            <p className="text-white text-[16.5px] font-[700] leading-[24px]">
              무료 진단받기
            </p>
            <Image
          ...
          <motion.div variants={vFadeUp} className="mt-[24px]">
            <Image
      ...
      >
        ...
        {/* 스와이퍼 영역 */}
        <motion.div variants={vFadeUp} className="relative flex-1 min-w-0">
          {/* 좌측 Gradient */}
          <div
