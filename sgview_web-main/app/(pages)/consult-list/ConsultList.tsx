...
const ConsultList = () => {
  ...
  return (
    <div className='pt-[40px] pb-[120px] max-w-[1440px]'>
      <div className='w-full  mx-auto  flex items-start justify-start gap-[24px] px-[144px]'>
        <div className='flex flex-col items-start justify-start gap-[12px] min-w-[270px]'>
